...
import { fetchCSRFToken } from '../LoginForm/authServiceL';
import api from '../api';
        ...
        <header className="header">
            <nav className={`navbar ${scrolling ? 'scrolled' : ''}`}>
                ...
                <ul className={menuOpen ? 'open' : ''}>
                    ...
                    <li>
                        <button className="loginButton" onClick={openLoginModal}>Login | Logout</button>
                    </li>
                </ul>
            </nav>

            {/* Conditionally render modals */}
            {loginModalOpen && <LoginModal closeModal={closeLoginModal} openRegistrationModal={openRegistrationModal} />}
            {registrationModalOpen && <RegistrationModal closeModal={closeRegistrationModal} openLoginModal={openLoginModal} />}
            {selectedCard && <CardDetailModal card={selectedCard} closeModal={closeCardDetailModal} userEmail={userEmail} />}
